...
if [ -d /data/adb/modules/unlimitedgpics/system/product/etc/sysconfig ]; then
    for i in /data/adb/modules/unlimitedgpics/system/product/etc/sysconfig/*; do
        file=$i
        file=${file/\/data\/adb\/modules\/unlimitedgpics\/system\/product\/etc\/sysconfig\//}
        if [ ! -f $MODPATH/system/product/etc/sysconfig/$file ]; then
            cp -f /data/adb/modules/unlimitedgpics/system/product/etc/sysconfig/$file $MODPATH/system/product/etc/sysconfig/$file
        fi
    done
fi
if [ -d /data/adb/modules/unlimitedgpics/system/etc/sysconfig ]; then
    for i in /data/adb/modules/unlimitedgpics/system/etc/sysconfig/*; do
        file=$i
        file=${file/\/data\/adb\/modules\/unlimitedgpics\/system\/etc\/sysconfig\//}
        if [ ! -f $MODPATH/system/etc/sysconfig/$file ]; then
            cp -f /data/adb/modules/unlimitedgpics/system/etc/sysconfig/$file $MODPATH/system/etc/sysconfig/$file
        fi
    done
fi
